...
public class PPHolonomicDriveControllerCustom implements PathFollowingController {
   ...
   */
  public PPHolonomicDriveControllerCustom(
  ...
  public static void setRotationTargetOverride(
      ...
      PPHolonomicDriveControllerCustom.rotationTargetOverride = rotationTargetOverride;
  }

  /**
   * Begin overriding the X axis feedback.
   *
   * @param xFeedbackOverride Double supplier that returns the desired
   *                          FIELD-RELATIVE X feedback in
   *                          meters/sec
   */
  public static void overrideXFeedback(DoubleSupplier xFeedbackOverride) {
    PPHolonomicDriveControllerCustom.xFeedbackOverride = xFeedbackOverride;
  }
  ...
  public static void clearXFeedbackOverride() {
    PPHolonomicDriveControllerCustom.xFeedbackOverride = null;
  }

  /**
   * Begin overriding the Y axis feedback.
   *
   * @param yFeedbackOverride Double supplier that returns the desired
   *                          FIELD-RELATIVE Y feedback in
   *                          meters/sec
   */
  public static void overrideYFeedback(DoubleSupplier yFeedbackOverride) {
    PPHolonomicDriveControllerCustom.yFeedbackOverride = yFeedbackOverride;
  }
  ...
  public static void clearYFeedbackOverride() {
    PPHolonomicDriveControllerCustom.yFeedbackOverride = null;
  }
   ...
   *
   * @param rotationFeedbackOverride Double supplier that returns the desired
   *                                 rotation feedback in
   *                                 radians/sec
   */
  public static void overrideRotationFeedback(DoubleSupplier rotationFeedbackOverride) {
    PPHolonomicDriveControllerCustom.rotFeedbackOverride = rotationFeedbackOverride;
  }
  ...
  public static void clearRotationFeedbackOverride() {
    PPHolonomicDriveControllerCustom.rotFeedbackOverride = null;
  }
